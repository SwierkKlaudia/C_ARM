...
void Timer1Interrupts_Init(unsigned int uiPeriod, void (*ptrInterruptFunction)()){ // microseconds
	...
	VICVectCntl10  = mIRQ_SLOT_ENABLE | VIC_TIMER1_CHANNEL_NR;  // Enable Slot 10 and assign it to Timer 1 interrupt channel
	VICVectAddr10  =(unsigned long)Timer1IRQHandler; 	   // Set to Slot 10 Address of Interrupt Service Routine 
